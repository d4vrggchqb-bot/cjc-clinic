...
const AddMedicineModal: React.FC<AddMedicineModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const confirmed = await confirm({
      ...
      message: `Are you sure you want to add ${formData.quantity} units of ${formData.generic_name} to Main Inventory?`,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs font-semibold text-slate-700 mb-1">
                Medicine Name (Generic) <span className="text-rose-500">*</span>
              </label>
              <input
                type="text"
                name="generic_name"
