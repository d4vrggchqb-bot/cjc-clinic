  ...
  `;
    ...
    switch (page) {
        ...
        case 'patients':
            ...
            const patientFilter = document.getElementById('patientTypeFilter');
            ...
            uploadForm?.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    if (uploadStatus) {
                        uploadStatus.textContent = err.message || 'Attachment upload failed.';
                        uploadStatus.style.color = '#ef4444';
                    }
                }
            });
        ...
        case 'inventory':
            await loadInventory();
            const invFilter = document.getElementById('inventoryCategoryFilter');
        ...
        case 'consultation':
            ...
            const patientNameInput = document.getElementById('issuedTo');
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    const profiles = patientData.profiles || [];
                    if (profileSelect) {
            ...
            const certForm = document.getElementById('medcertForm');
